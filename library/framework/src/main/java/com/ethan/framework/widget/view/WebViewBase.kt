package com.ethan.framework.widget.view
...
import com.ethan.zincum.BuildConfig
 ...
 * 腾讯X5WebView
 */
open class WebViewBase @JvmOverloads constructor(context: Context, attr: AttributeSet? = null) : WebView(context, attr) {
    ...
    private fun initSetting() {
        ...
        settings.apply {
            ...
            javaScriptCanOpenWindowsAutomatically = true //适应手机屏幕
            useWideViewPort = true
            loadWithOverviewMode = true
            layoutAlgorithm = com.tencent.smtt.sdk.WebSettings.LayoutAlgorithm.NARROW_COLUMNS //无限放大
