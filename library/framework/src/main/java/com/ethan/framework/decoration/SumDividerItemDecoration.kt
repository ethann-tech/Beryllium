 ...
 */
package com.ethan.framework.decoration
...
class SumDividerItemDecoration(context: Context, orientation: Int) : ItemDecoration() {
    ...
    init {
        ...
        if (drawable == null) {
            Log.w(
                TAG, "@android:attr/listDivider was not set in the theme used for this " + "DividerItemDecoration. Please set that attribute all call setDrawable()"
            )
        }
        a.recycle()
